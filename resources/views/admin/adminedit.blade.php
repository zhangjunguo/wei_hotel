				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
                            <form class="form-horizontal" role="form" action="adminsel" method="post">
                             @foreach($arr as $v)
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">管理员名称</label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="username" placeholder="Username" class="col-xs-10 col-sm-5" value="{{$v->adm_name}}" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-3" placeholder="email" name="email" class="col-xs-10 col-sm-5"  value="{{$v->adm_email}}" />
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-4" placeholder="Phone" name="phone" class="col-xs-10 col-sm-5" value="{{$v->adm_phone}}" />
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
								     <div class="col-sm-9">
								           <input type="hidden" name="id" value="{{$v->adm_id}}" />
