...
<button id="search" style="height:30px;background:#cccccc;" onclick="page(1)">搜索</button> -->
										<div id="div1">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												@foreach($arr as $k => $v)
													<tr>
                                                        ...
                                                        <td><span onmouseover="block(this)">{{$v->o_num}}</span></td>
                                                        <td>{{$v->user_name}}</td>
                                                        <td>{{$v->h_name}}</td>
                                                        <td>{{$v->r_name}}</td>
                                                        <td>{{$v->od_count}}</td>
                                                        <td>{{$v->od_xiaoji}}</td>
                                                        <td>{{date('Y-m-d',$v->od_start_time)}}</td>
                                                        <td>{{date('Y-m-d',$v->od_end_time)}}</td>
                                                  <!--       <td>{{$v->user_name}}</td>
