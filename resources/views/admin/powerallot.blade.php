                ...
                <div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
                            <form class="form-horizontal" role="form" action="powerallotok" method="post">
                                  <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-3">选择角色</label>
                                         <div class="col-sm-9">
											<select name="rid">
											  @foreach($results as $vo)
												<option value="{{$vo->ro_id}}">{{$vo->ro_name}}</option>
											  @endforeach
											</select>
										</div>
									</div>
                                        ...
                                        <div class="col-sm-9">
											  @foreach($arr as $v)
												 <?php echo str_repeat('&nbsp&nbsp&nbsp&nbsp',$v->level);?>
                                                       <input type="checkbox" name="p_id[]" value="{{$v->p_id}}" />{{$v->p_name}}<br/>
											  @endforeach
										</div>
									</div>
                                    <div class="space-4"></div>
