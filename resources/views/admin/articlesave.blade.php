				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
                            <form class="form-horizontal" role="form" onsubmit="return test()" action="articleupdate" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">文章标题</label>

										<div class="col-sm-9">
											<input type="text" id="title"  name="ar_title" placeholder="请输入文章标题" class="col-xs-10 col-sm-5" value="{{$data->ar_title}}" onblur="check_title()" />
											<span id="show_title"></span>
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">文章原图片</label>

										<div class="col-sm-9">
										<a href="{{$data->ar_img}}">	<img src="{{$data->ar_img}}" style="width: 50%; height="50%" " alt="图片"></a>
										</div>
									</div>	
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name="ar_text" class="common-textarea" id="content" cols="30" style="width: 50%;" rows="10">{{$data->ar_text}}</textarea>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
								     <div class="col-sm-9">
								     <input type="hidden" name="img" value="{{$data->ar_img}}">
								     <input type="hidden" name="ar_id" value="{{$data->ar_id}}">
