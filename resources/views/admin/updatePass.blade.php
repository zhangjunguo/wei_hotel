									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="passUpdate" method="post">
												...
												<input type="hidden" name='adm_id' value="{{$u_id}}"\>
												<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="原密码" name="old_pass" />
															<i class="icon-user"></i>
														</span>
													</label>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="新密码" name="adm_pass" />
															<i class="icon-user"></i>
														</span>
													</label>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control" placeholder="确认密码" name="check_pass" />
															<i class="icon-lock"></i>
														</span>
													</label>
                                                     <label class="block clearfix">
											...
											<!-- <div class="social-or-login center">
												<span class="bigger-110">或使用以下登陆</span>
											</div>
