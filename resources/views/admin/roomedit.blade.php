				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
                            <form class="form-horizontal" role="form" action="RoomEdit" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="h_id" id="hid" value="{{$data->h_id}}">
                            <input type="hidden" name="r_id" value="{{$data->r_id}}">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="r_name" placeholder="" class="col-xs-10 col-sm-5" value="{{$data->r_name}}"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="" name="r_price" class="col-xs-10 col-sm-5" value="{{$data->r_price}}"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-3" placeholder="" name="r_vip_price" class="col-xs-10 col-sm-5" value="{{$data->r_vip_price}}"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-4" placeholder="" name="r_pro_price" class="col-xs-10 col-sm-5" value="{{$data->r_pro_price}}"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-4" placeholder="" name="r_num" class="col-xs-10 col-sm-5" value="{{$data->r_num}}"/>
										</div>
									</div>
