                                ...
                                <div id="div2">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        @foreach($gift_data as $v)
                                            <tbody>
                                            <tr>
                                                <td class="center">{{$v->g_id}}</td>
                                                <td class="center">{{$v->g_name}}</td>
                                                <td>{{$v->g_num}}</td>
                                                <td><img src="./storage/uploads/{{$v->g_img}}" alt="" width="100" heigth="100"/></td>
                                                <td>{{$v->g_score}}</td>
                                                <td>{{$v->g_text}}</td>
                                                <td>
                                                    <a href="giftEdit?g_id={{$v->g_id}}">
                                                        <button class="btn btn-xs btn-info">
                                                            <i class="icon-edit bigger-120"></i>
                                                        </button>
                                                    </a>

                                                    <a href="giftDel?g_id={{$v->g_id}}">
